...
const Share = () => {
    ...
    const submitForm = async (e) => {
        ...
        if (image) {
            ...
            try {
                let postRes = await axios.post('http://localhost:9000/api/v1/post', data, {
                    headers: {
            ...
            try {
                let postRes = await axios.post('http://localhost:9000/api/v1/post', noImage, {
                    headers: {
                        'content-type': 'application/json',
                        'access-token':  user.token
                    }
            ...
            <div className="share__wrapper">
                ...
                <form className="share__bottom" onSubmit={submitForm}>
                    <div className="share__options">
                        ...
                        <div className='share__option'>
                            <EmojiEmotions className="share__icon" htmlColor='gold'/>
